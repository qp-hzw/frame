...
/* ********************************************************************************
** 简要描述: ModuleListControl 和 ServerListControl的基类
** 详细描述: 为ModuleListControl, ServerListControl提供基本控件功能
** 修 改 人: 
** 修改记录:
** *******************************************************************************/
//列表控件
...
protected:
	...
	//组件变量
protected:
	CListHeaderCtrl					m_ListHeaderCtrl;					//列头控件  GameGameItem信息
