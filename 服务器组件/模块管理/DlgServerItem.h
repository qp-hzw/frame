...
class MODULE_MANAGER_CLASS CDlgServerItem : public CDialog
{
	//列表变量
protected:
	CServerItemManager				m_ServerItemMap;					//ServerItemMap
...
public:
	...
	bool OpenGameServer();
	//打开房间
	bool OpenGameServer(DWORD wServerID);
...
protected:
	...
	//获取参数
	bool GetModuleInitParameter(tagGameRoomItem * pGameServerInfo, bool bAutoMode);
