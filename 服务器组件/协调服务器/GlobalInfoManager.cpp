...
//删除用户
bool CGlobalInfoManager::DeleteUserItem(DWORD dwUserID, DWORD wServerID)
{
	//寻找用户
	CGlobalUserItem * pGlobalUserItem=NULL;
...
//激活用户
bool CGlobalInfoManager::ActiveUserItem(tagGlobalUserInfo & GlobalUserInfo, DWORD wServerID)
{
	//寻找房间
	CGlobalServerItem * pGlobalServerItem=NULL;
...
//删除房间
bool CGlobalInfoManager::DeleteServerItem(DWORD wServerID)
{
	//寻找房间
	CGlobalServerItem * pGlobalServerItem=NULL;
	if (m_MapServerID.Lookup(wServerID,pGlobalServerItem)==FALSE)
...
//寻找房间
CGlobalServerItem * CGlobalInfoManager::SearchServerItem(DWORD wServerID)
{
	//寻找房间
	CGlobalServerItem * pGlobalServerItem=NULL;
...
CGlobalServerItem * CGlobalInfoManager::EnumServerItem(POSITION & Position)
{
	...
	//获取对象			//lee：m_MapServerID这个赋值是在游戏服传来的【注册房间】中赋值的
